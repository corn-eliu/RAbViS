...
class CMT(object):
	...
	def initialise(self, im_gray0, tl, br, tr=None, bl=None):
		...
		if tr != None and bl != None :
			p = Path([tl, tr, br, bl, tl])
			ind = p.contains_points(util.keypoints_cv_to_np(keypoints_cv))
		else :
